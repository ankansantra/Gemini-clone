  ...
  return (
    <div className='main'>
        ...
        <>
            ...
            <div className="cards">
                <div className="card">
                    <p>Suggest beautiful places to on an upcoming road trip</p>
                    <img src={assets.compass_icon} alt=''/>
                </div>
                <div className="card">
                    <p>Briefly explain what you're looking for in a new job opportunity</p>
                    <img src={assets.bulb_icon} alt=''/>
                </div>
                <div className="card">
                    <p>Brainstorm team members to get a new project off the ground</p>
        ...
        <div className='result'>
                ...
                <div className="result-title">
                    <img src={assets.user_icon} alt='usericon'/>
                     {/* Displaying recent prompt */}
                    <p>{recentPrompt}</p>
                </div>
                <div className="result-data">
                    <img src={assets.gemini_icon} alt=''/>
                    {/* Show loader if loading, else display result data */}
